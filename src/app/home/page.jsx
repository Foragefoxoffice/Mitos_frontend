  ...
  return (
    <main className="bg-white text-gray-800 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="text-lg md:text-xl mb-8 max-w-2xl mx-auto text-indigo-100">
            Practice. Analyze. Improve. Everything you need to master NEET 2025
            is here.
          </p>
      ...
      <section
        id="features"
        ref={featuresRef}
        className="px-6 py-20 md:px-20 bg-white"
      >
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          >
            Our platform is designed to give you the competitive edge in NEET
            preparation
          </motion.p>
        </div>
          ...
          {[
            {
              ...
              title: "Chapterwise Tests",
              desc: "Based on updated NEET syllabus from NCERT.",
              color: "text-purple-500",
            },
            {
              icon: <FaChartLine size={36} />,
              title: "Performance Insights",
              desc: "Smart analytics with subject/topic breakdown.",
              color: "text-blue-500",
            },
            {
              icon: <FaShieldAlt size={36} />,
              title: "Verified Solutions",
              desc: "Curated questions with accurate keys.",
              color: "text-green-500",
            },
            {
              icon: <FaCheckCircle size={36} />,
              title: "Premium Unlocks",
              desc: "Access exclusive tricky MCQs & solutions.",
