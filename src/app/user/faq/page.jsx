      ...
      {loading ? (
        ...
        <div className="min-h-screen ">
          <Head>
            ...
            <meta
              name="description"
              content="Frequently asked questions about our NEET mock test platform"
            />
          </Head>

          <main className="container mx-auto px-4 py-12">
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold text-[#35095E]">
                Frequently Asked Questions
              </h1>
              <p className="text-xl text-gray-600">
                Find answers to common questions about our NEET mock test
                platform
              </p>
            </div>
                ...
                >
                  ...
                  >
                    <div className="flex justify-between items-center">
                      ...
                      <svg
                        className={`w-5 h-5 text-[#35095E] transform transition-transform duration-200 ${
